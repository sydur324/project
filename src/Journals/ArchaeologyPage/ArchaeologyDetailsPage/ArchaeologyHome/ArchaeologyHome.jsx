...
const ArchaeologyHome = () => {
    return (
        <div className='w-full'>
            <div className='archaeology_bg text-white px-4 py-4'>
            ...
            <div className='py-6 '>
                <p>
                    ...
                    which publishes original papers promoting theoretical, methodological and empirical developments in the
                    discipline of socio-cultural anthropology. The journal provides a forum where a wide variety of different
                    anthropologies can gather together and enter into critical exchange. It encourages submissions both from
                    scholars working in anthropology and those in other disciplines whose work can make a substantial
                    contribution to topics of concern to anthropologists. The journal publishes original papers that promote
                    theoretical, methodological and empirical developments within the disciplines of anthropology and archeology.
                    All research articles published in Journal of Anthropology and Archaeology have undergone rigorous peer review,
                    based on initial editor screening and anonymized refereeing by at least two anonymous referees.
                </p>
