                            ...
                            <div className="px-4 py-6">
                                ...
                                <div className="my-2">
                                    <select className="px-2 py-2 border outline-none w-full">
                                        <option value="">Accounting and Taxation</option>
                        ...
                        <div className='lg:w-3/4'>
                            ...
                            <div>
                                <div className='journal_box_upper'>
                                    <div className='flex space-x-2 my-2 items-center'>
                                        ...
                                        <p className='text-sm font-medium text-[#072159]'>International Journal of Accounting and Taxation</p>
                                    </div>
                            ...
                            <div className='my-4 border-2 p-8 flex flex-wrap xl:flex-nowrap gap-4 cursor-pointer hover:shadow-md'>
                                ...
                                <div className='lg:w-2/3'>
                                    <h2 className='font-medium text-[#072159] xl:text-xl lg:text-xl md:text-xl text-lg '>International Journal of Accounting and Taxation</h2>
                                    <div className='py-2'>
                                    ...
                                    <p>
                                        International Journal of Accounting and Taxation is a double blind peer
                                        reviewed journal that publishes original research papers using analytical,
                                        empirical, experimental, and field study methods in all areas of accounting research.
                                    </p>
                                </div>
                            </div>
                            </Link>
